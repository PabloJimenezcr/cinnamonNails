...
class AdminProductsEditWidget extends StatefulWidget {
  const AdminProductsEditWidget({
    super.key,
  ...
  static String routeName = 'adminProductsEdit';
  static String routePath = '/adminProductsEdit';

  @override
  State<AdminProductsEditWidget> createState() =>
      _AdminProductsEditWidgetState();
}

class _AdminProductsEditWidgetState extends State<AdminProductsEditWidget> {
  late AdminProductsEditModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminProductsEditModel());
                    ...
                    children: [
                      FFButtonWidget(
                        onPressed: () async {
                          ...
                          context.pushNamed(
                            AdminProductosWidget.routeName,
