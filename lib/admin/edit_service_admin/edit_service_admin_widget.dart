...
import 'edit_service_admin_model.dart';
export 'edit_service_admin_model.dart';

class EditServiceAdminWidget extends StatefulWidget {
  const EditServiceAdminWidget({super.key});

  static String routeName = 'editServiceAdmin';
  static String routePath = '/editServiceAdmin';

  @override
  State<EditServiceAdminWidget> createState() => _EditServiceAdminWidgetState();
}

class _EditServiceAdminWidgetState extends State<EditServiceAdminWidget> {
  late EditServiceAdminModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditServiceAdminModel());
