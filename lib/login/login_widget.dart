...
import '/components/password_recovery/password_recovery_widget.dart';
...
class _LoginWidgetState extends State<LoginWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      safeSetState(() {
        _model.emailInputTextController?.text = FFAppState().savedEmail;
      });
    });
