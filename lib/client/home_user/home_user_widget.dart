                  ...
                  Row(
                    ...
                    children: [
                      InkWell(
                        ...
                        onTap: () async {
                          context.pushNamed(ServicesClientWidget.routeName);
                        },
                        child: Column(
                          mainAxisSize: MainAxisSize.max,
                      ...
                      InkWell(
                        ...
                        onTap: () async {
                          context
                              .pushNamed(AppointmentManagementWidget.routeName);
                        },
                        child: Column(
                          mainAxisSize: MainAxisSize.max,
                          crossAxisAlignment: CrossAxisAlignment.center,
                                  ...
                                  Stack(
                                    children: [
                                      ...
                                      ClipRRect(
                                        ...
                                        child: Image.asset(
                                          'assets/images/fotoGelColor.png',
                                          width: 353.4,
                                          height: 100.0,
                                          fit: BoxFit.contain,
                                    ...
                                    children: [
                                      ...
                                      ClipRRect(
                                        borderRadius:
                                            BorderRadius.circular(8.0),
                                        child: Image.asset(
                                          'assets/images/fotoGelColor2.png',
                                          width: 353.95,
                                          height: 100.0,
                                          fit: BoxFit.contain,
                                          alignment: Alignment(1.0, 0.0),
                                    ...
                                    children: [
                                      ...
                                      ClipRRect(
                                        borderRadius:
                                            BorderRadius.circular(8.0),
                                        child: Image.asset(
                                          'assets/images/fotoGelColor3.png',
                                          width: 354.88,
                                          height: 100.0,
                                          fit: BoxFit.contain,
                                          alignment: Alignment(1.0, 0.0),
                                    ...
                                    children: [
                                      ...
                                      ClipRRect(
                                        borderRadius:
                                            BorderRadius.circular(8.0),
                                        child: Image.asset(
                                          'assets/images/fotoGelColor4.png',
                                          width: 354.9,
                                          height: 100.0,
                                          fit: BoxFit.contain,
                                          alignment: Alignment(1.0, 0.0),
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                context.pushNamed(
                                  ...
                                  extra: <String, dynamic>{
                                    'service': gridViewServicesRecord,
                                    '__transition_info__': TransitionInfo(
                                      hasTransition: true,
                                      transitionType: PageTransitionType.fade,
                                    ),
                                ...
                                children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        gridViewServicesRecord.price.toString(),
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              font: GoogleFonts.montserrat(
