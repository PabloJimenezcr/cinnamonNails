...
class AdminServicesAddWidget extends StatefulWidget {
  const AdminServicesAddWidget({super.key});

  static String routeName = 'adminServicesAdd';
  static String routePath = '/adminServicesAdd';

  @override
  State<AdminServicesAddWidget> createState() => _AdminServicesAddWidgetState();
}

class _AdminServicesAddWidgetState extends State<AdminServicesAddWidget> {
  late AdminServicesAddModel _model;
