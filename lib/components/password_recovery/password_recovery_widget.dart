...
class _PasswordRecoveryWidgetState extends State<PasswordRecoveryWidget> {
  ...
  void initState() {
    ...
    _model.emailRecoveryPasswordTextController ??= TextEditingController();
    _model.emailRecoveryPasswordFocusNode ??= FocusNode();
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    width: double.infinity,
                    child: TextFormField(
                      controller: _model.emailRecoveryPasswordTextController,
                      focusNode: _model.emailRecoveryPasswordFocusNode,
                      autofocus: false,
                      obscureText: false,
                  ...
                  FFButtonWidget(
                    onPressed: () async {
                      if (_model
                          .emailRecoveryPasswordTextController.text.isEmpty) {
                      ...
                      await authManager.resetPassword(
                        email: _model.emailRecoveryPasswordTextController.text,
                        context: context,
                      );
                      await showDialog(
                        context: context,
