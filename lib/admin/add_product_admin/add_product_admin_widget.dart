...
import 'add_product_admin_model.dart';
export 'add_product_admin_model.dart';

class AddProductAdminWidget extends StatefulWidget {
  const AddProductAdminWidget({super.key});

  static String routeName = 'addProductAdmin';
  static String routePath = '/addProductAdmin';

  @override
  State<AddProductAdminWidget> createState() => _AddProductAdminWidgetState();
}

class _AddProductAdminWidgetState extends State<AddProductAdminWidget> {
  late AddProductAdminModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddProductAdminModel());
    ...
    _model.productDescriptionInputTextController ??= TextEditingController();
    _model.productDescriptionInputFocusNode ??= FocusNode();

    _model.productBrandInputTextController ??= TextEditingController();
