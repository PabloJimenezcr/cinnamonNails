...
import 'admin_services_model.dart';
export 'admin_services_model.dart';

/// Salon Services Management Interface
class AdminServicesWidget extends StatefulWidget {
  const AdminServicesWidget({super.key});

  static String routeName = 'adminServices';
  static String routePath = '/adminServices';

  @override
  State<AdminServicesWidget> createState() => _AdminServicesWidgetState();
}

class _AdminServicesWidgetState extends State<AdminServicesWidget> {
  late AdminServicesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminServicesModel());
                  ...
                  children: [
                    ...
                    Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(10.0, 0.0, 0.0, 0.0),
                      child: Text(
                        'Administre los servicios que el salon ofrece.',
                                                        ...
                                                        var confirmDialogResponse =
                                                            await showDialog<
                                                                  ...
                                                                  builder:
                                                                    ...
                                                                    return AlertDialog(
                                                                      title: Text(
                                                                          'Confirmar eliminacion de servicio?'),
                                                                      content: Text(
