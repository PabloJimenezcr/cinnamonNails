...
import 'confirmation_appointment_model.dart';
...
class ConfirmationAppointmentWidget extends StatefulWidget {
  ...
  @override
  State<ConfirmationAppointmentWidget> createState() =>
      _ConfirmationAppointmentWidgetState();
}

class _ConfirmationAppointmentWidgetState
    extends State<ConfirmationAppointmentWidget> {
  late ConfirmationAppointmentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ConfirmationAppointmentModel());
